    ...
    <div style={{ fontFamily: "system-ui", padding: "24px" }}>
      ...
      <section id="summary" className="space-y-4">
        ...
        <div className="p-6 rounded-xl bg-blue-50/50 border border-blue-100 text-blue-900 space-y-3 text-base leading-relaxed">
          <p>Building reusable UIs with components and props:</p>
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Functional Components:</strong> JavaScript functions that return JSX, named with a capital letter.</li>
            <li><strong>Props:</strong> Arguments passed from parent to child components to make them dynamic and reusable.</li>
            <li><strong>Destructuring Props:</strong> A cleaner way to access specific prop values directly in the function signature.</li>
            <li><strong>One-way Data Flow:</strong> Props are read-only for children and flow from parents down the component tree.</li>
          </ul>
        </div>
      </section>
