...
export const TOPICS: Topic[] = [
  ...
  // ── 03 JavaScript ──────────────────────────────────────────────────────────
  {
    ...
    lessons: [
      ...
      { id: "javascript-module02variablesdatatypes", title: "Variables & Data Types", description: "let, const, strings, numbers, booleans, and variable naming conventions.", duration: "50 mins" },
      ...
      { id: "javascript-module04functions", title: "Functions", description: "Declarations, expressions, arrow functions, default params, and scope.", duration: "1 hr" },
      ...
      { id: "javascript-module06objectsbasics", title: "Objects Basics", description: "Creating objects, methods, shorthand properties, and for...in loops.", duration: "45 mins" },
      { id: "javascript-module07dommanipulation", title: "DOM Manipulation", description: "Query elements, handle events, and update the page dynamically.", duration: "1.5 hrs" },
      { id: "javascript-module08projectquiz", title: "Project — Quiz App", description: "Build a fully interactive, scored quiz app using vanilla JS — your first real project.", duration: "2 hrs" },
    ],
  },
  ...
  // ── 04 JS Advanced ─────────────────────────────────────────────────────────
  {
    ...
    lessons: [
      ...
      { id: "javascript-advanced-module01howjsworks", title: "How JS Works", description: "Execution context, call stack, hoisting, scope chain, and closures.", duration: "1.5 hrs" },
      { id: "javascript-advanced-module02es6features", title: "ES6+ Features", description: "Destructuring, spread, rest, template literals, optional chaining, nullish coalescing.", duration: "1 hr" },
      { id: "javascript-advanced-module03functionalprogramming", title: "Functional Programming", description: "Pure functions, first-class functions, immutability, and advanced array methods.", duration: "1 hr" },
      { id: "javascript-advanced-module04asyncjavascript", title: "Async JavaScript", description: "The event loop, callbacks, Promises, and async/await.", duration: "1.5 hrs" },
      { id: "javascript-advanced-module05workingapis", title: "Working with APIs", description: "Fetch API, REST principles, JSON, and real-world data patterns.", duration: "1 hr" },
      { id: "javascript-advanced-module06classesoop", title: "Classes & OOP", description: "ES6 classes, constructors, inheritance, and object-oriented design.", duration: "1 hr" },
      { id: "javascript-advanced-module07advanceddom", title: "Advanced DOM", description: "Event bubbling, capturing, and high-performance event delegation.", duration: "1 hr" },
      { id: "javascript-advanced-module08modulesnpm", title: "Modules & npm", description: "import/export, npm packages, package.json, and node_modules.", duration: "50 mins" },
      { id: "javascript-advanced-module09errorhandling", title: "Error Handling", description: "try/catch, custom errors, and defensive programming.", duration: "45 mins" },
      { id: "javascript-advanced-module10projectweather", title: "Project — Weather App", description: "Build a live weather app using a public API and async/await.", duration: "2 hrs" },
    ],
  },
